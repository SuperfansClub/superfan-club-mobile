...
type SeverityLevel = 'complaint' | 'severe_complaint';
...
export default function NotificationChannelScreen() {
  ...
  const [selectedSeverity, setSelectedSeverity] = useState<SeverityLevel>('complaint');
  ...
  const severityOptions = [
    {
      level: 'severe_complaint' as SeverityLevel,
      title: 'Critical Issues Only',
      description: 'Urgent complaints and serious problems requiring immediate attention',
      icon: 'alert-circle',
      color: '#EF4444',
      bgColor: '#FEF2F2',
    },
    {
      level: 'complaint' as SeverityLevel,
      title: 'All Complaints',
      description: 'All customer complaints and feedback requiring attention',
      icon: 'warning',
      color: '#F59E0B',
      bgColor: '#FFFBEB',
    },
