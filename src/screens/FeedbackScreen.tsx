      ...
      >
        ...
        {item.isEscalated && (
          <View style={[styles.escalationBanner, { 
            backgroundColor: item.severity === 'severe_complaint' ? '#FEF2F2' : '#FFFBEB'
          }]}>
            <Ionicons 
              name={item.severity === 'severe_complaint' ? 'alert-circle' : 'warning'} 
              size={16} 
              color={item.severity === 'severe_complaint' ? '#EF4444' : '#F59E0B'} 
            />
